...
const Icons = {
  ...
  DME: () => <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 16h6"/><path d="M19 13v6"/><rect width="20" height="14" x="2" y="6" rx="2"/><path d="M7 15h.01"/><path d="M11 15h.01"/></svg>,
  Meds: () => <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m10.5 20.5 10-10a4.95 4.95 0 1 0-7-7l-10 10a4.95 4.95 0 1 0 7 7Z"/><path d="m8.5 8.5 7 7"/></svg>,
  MultiMeds: () => <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 3h5v5M8 3H3v5M3 16v5h5M21 16v5h-5M7 12h10M12 7v10"/></svg>,
  Messaging: () => <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>,
    ...
    <div className="min-h-screen flex flex-col md:flex-row bg-slate-50">
      ...
      <aside className="hidden md:flex flex-col w-64 bg-slate-900 text-white p-6 sticky top-0 h-screen overflow-y-auto">
        <div className="mb-8">
          ...
          <p className="text-xs text-slate-400 mt-1 uppercase tracking-widest font-semibold">DME Portal</p>
        </div>
      ...
      <header className="md:hidden bg-slate-900 text-white p-4 sticky top-0 z-[200] flex justify-between items-center">
        ...
        <button onClick={onLogout} className="text-sm text-slate-400 flex items-center space-x-1">
          <Icons.Logout />
          <span>Out</span>
        </button>
      </header>
